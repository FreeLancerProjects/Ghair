...
public class SlidingImageMarket_Adapter extends PagerAdapter {


    List<UserModel.Banners> IMAGES;
    private LayoutInflater inflater;
     Context context;

    public SlidingImageMarket_Adapter(Context context, List<UserModel.Banners> IMAGES) {
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        ...
        Picasso.with(context).load(Uri.parse(Tags.IMAGE_URL+IMAGES.get(position).getImage())).placeholder(R.drawable.shiop).fit().into(rowBinding.image);
