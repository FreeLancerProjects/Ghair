...
import com.endpoint.ghair.databinding.MyproductRowBinding;
...
public class MyProductsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MyProductsAdapter(List<Product_Model.Data> orderlist, Context context) {
 ...
 lang = Paper.book().read("lang", Locale.getDefault().getLanguage());}
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType==ITEM_DATA) {
            MyproductRowBinding binding = DataBindingUtil.inflate(inflater, R.layout.myproduct_row, parent, false);
...
if(i!=position) {
    ...
    public class EventHolder extends RecyclerView.ViewHolder {
        ...
        public EventHolder(@NonNull MyproductRowBinding binding) {
